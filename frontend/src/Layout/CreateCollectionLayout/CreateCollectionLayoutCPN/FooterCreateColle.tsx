...
import BtnPublishContractColle from "./BtnPublishContractColle";

const FooterCreateColle = ({ selectedFile, collectionData }: {
    ...
    <>
      <div className="flex items-center justify-end px-10 space-x-5 border-t-1 border-[#181C14] py-4">
        <Link to="" className="">
         ...
         <BtnPublishContractColle selectedFile={selectedFile} collectionData={collectionData}></BtnPublishContractColle>
      </div>
    </>
  );
};
